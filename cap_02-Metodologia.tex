...
que os dois computadores utilizados nos experimentos deste trabalho foram \textit{notebooks} com as seguintes especificações: 

Computador 1: Intel® Core™ i7-2630QM CPU @ 2.00GHz × 8 , 6GB ram, GeForce GT 540M/PCIe/SSE2, Ubuntu 14.04, OpenGL ?.

Computador 2: Intel® Core™ i7-4510U CPU @ 2.00GHz × 4 , 16GB ram, sem placa de vídeo, Ubuntu 16.04, OpenGL 3.3*.
